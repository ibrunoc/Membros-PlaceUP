...
import kayky from "./imgs/Kayky.svg";
import { AiFillGithub, AiOutlineStar } from "react-icons/ai";

export default function Kayky() {
  return (
    <>
      <Container>
        <div>
        ...
        <div className="cards">
          <div className="backgroundCard">
            ...
            <div className="containerInfoCards">
              <img src={kayky} alt="Foto da perfil" />
              <h1>Kayky Freitas</h1>
              <p>BACK-END</p>
              ...
              <div className="buttonSocialMedias">
                <a
                  href="https://www.linkedin.com/in/kaykyfreitas/"
                  target="blanked"
                >
                  <button>
                    <h2>Linkedin</h2>
                ...
                <a href="https://github.com/kaykyFreitas" target="blanked">
                  <button>
                    <h2>Git hub</h2>
                  </button>
                </a>
